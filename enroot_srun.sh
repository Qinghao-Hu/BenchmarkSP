...
/workspace/target-linux-x64/nsys profile --force-overwrite true -o ${LOG_DIR}/nsys_reports/ours-32GPU_hybrid_$SLURM_PROCID -y 45 -d 5 --capture-range=cudaProfilerApi accelerate launch \

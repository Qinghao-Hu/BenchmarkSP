...
def new_zigzag_flash_attn_forward(
    self,
    query_states,
    key_states,
    value_states,
...
def new_striped_flash_attn_forward(
    self,
    query_states,
    key_states,
    value_states,
...
def new_ring_flash_attn_forward(
    self,
    query_states,
    key_states,
    value_states,
...
def apply_zigzag_ring_attn_monkey_patch_llama():
    transformers.models.llama.modeling_llama.LlamaFlashAttention2._flash_attention_forward = new_zigzag_flash_attn_forward
...
def apply_ring_attn_monkey_patch_llama():
    transformers.models.llama.modeling_llama.LlamaFlashAttention2._flash_attention_forward = new_ring_flash_attn_forward
    transformers.models.llama.modeling_llama.LlamaDecoderLayer.forward = new_decoder_forward

def apply_striped_attn_monkey_patch_llama():
    transformers.models.llama.modeling_llama.LlamaFlashAttention2._flash_attention_forward = new_striped_flash_attn_forward
    transformers.models.llama.modeling_llama.LlamaDecoderLayer.forward = new_decoder_forward
